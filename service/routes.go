// Code generated by generator/service/main.go. DO NOT EDIT.
package service
...
// BookServiceContract defines what an implementation of BookService
...
type BookServiceContract interface {
	...
	Create(ctx context.Context, req *BookCreateRequest) (*model.Book, error)

	// Retrieve runs when a GET /api/book request comes in.
	Retrieve(ctx context.Context, req url.Values) (*BookRetrieveResponse, error)
}

// ExtractorServiceContract defines what an implementation of ExtractorService
// should look like. This interface is derived from the routes.json file
// provided as input to this generator, and it is a combination of the handler,
// the request, and the response.
type ExtractorServiceContract interface {
	// Create runs when a POST /api/extractor request comes in.
	Create(ctx context.Context, req *ExtractorCreateRequest) (*model.Extractor, error)
}

// EntryServiceContract defines what an implementation of EntryService
// should look like. This interface is derived from the routes.json file
// provided as input to this generator, and it is a combination of the handler,
// the request, and the response.
type EntryServiceContract interface {
	// Create runs when a POST /api/entry request comes in.
	Create(ctx context.Context, req *EntryCreateRequest) (*EntryCreateResponse, error)
...
func MountBookService(router *mux.Router, serv BookServiceContract) {
	log.Print("[INFO] mounting BookService on /api/book endpoint")
...
func MountExtractorService(router *mux.Router, serv ExtractorServiceContract) {
	log.Print("[INFO] mounting ExtractorService on /api/extractor endpoint")
...
func MountEntryService(router *mux.Router, serv EntryServiceContract) {
	log.Print("[INFO] mounting EntryService on /api/entry endpoint")
