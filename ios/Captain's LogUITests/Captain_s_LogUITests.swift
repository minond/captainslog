//
//  Captain_s_LogUITests.swift
//  Captain's LogUITests
//
...
class Captain_s_LogUITests: XCTestCase {
  override func setUp() {
  ...
  func testExample() {
    ...
    // Use recording to get started writing UI tests. Use XCTAssert and related
    // functions to verify your tests produce the correct results.
  }
