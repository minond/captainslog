...
func (r ApplicationSchema) RewriteSelect(stmt *sqlparse.SelectStmt, env Environment) (*sqlparse.SelectStmt, Environment, error) {
...
func (r ApplicationSchema) rewriteExpr(ex sqlparse.Expr, env Environment, autoAlias bool) (sqlparse.Expr, Environment) {
	switch x := ex.(type) {
